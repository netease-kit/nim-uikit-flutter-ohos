...
const String audioFromPlatform = 'audioFromPlatform';

const String audioPlatformOhos = 'platformOhos';
  ...
  Future<AudioContext> _getAudioContext() async {
    ...
    return AudioContext(
        ...
        ohos: AudioContextOhos(
          ...
          usageType: isSpeakerphoneOn
              ? OhosUsageType.music
              : OhosUsageType.voiceCommunication,
          audioScene: isSpeakerphoneOn
              ? OhosAudioScene.normal
              : OhosAudioScene.voiceChat,
        ));
  }
