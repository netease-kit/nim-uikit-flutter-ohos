...
class ChatViewModel extends ChangeNotifier {
  ...
  fetchMoreMessage(NIMQueryDirection direction, {bool haveNetwork = true}) {
    _fetchMoreMessage(
    ...
    ChatMessageRepo.getMessageList(option,
      ...
      if (value.isSuccess && value.data != null) {
        ...
        if (init &&
          ...
          _onListFetchSuccess(value.data!, direction, haveNetwork: haveNetwork);
        }
      ...
      if (value.isSuccess) {
        if (!Platform.isIOS && !Platform.isAndroid) {
          Map<String, dynamic> extension = {
            audioFromPlatform: audioPlatformOhos
          };
          value.data!.serverExtension = jsonEncode(extension);
        }
  ...
  void translateInputText(String sourceText, String language) {
    ...
    configParams.prompt =
        AIUserManager.instance.getAITranslateUser()?.modelConfig?.prompt;
