...
class MyAppState extends State<MyApp> {
  ...
  _openOHOSFile() async {
    // OpenFilex.open 需要传入有权限访问的文件地址才能访问，比如应用沙箱路径下的文件
    // 这里使用了其它三方库来自定义选取文件做功能展示
    String? path = await FlutterDocumentPicker.openDocument();
    if (path != null) {
      String filePath = "file://com.crazecoder.openfile.example$path";
      ...
      setState(() {
        _openResult = "User canceled the picker";
      });
    }
  }
