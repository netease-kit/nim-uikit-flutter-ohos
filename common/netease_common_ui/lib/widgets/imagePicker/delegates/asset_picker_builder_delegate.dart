...
class DefaultAssetPickerBuilderDelegate
  ...
  Future<void> onAssetsChanged(MethodCall call, StateSetter setState) async {
    ...
    if (call.arguments is Map) {
      ...
      if (arguments['newCount'] is int) {
        newCount = arguments['newCount'] as int;
      }
      if (arguments['oldCount'] is int) {
        oldCount = arguments['oldCount'] as int;
      }
      for (final e in (arguments['create'] as List?) ?? []) {
        if (e is Map && e['id'] is String) {
          createIds.add(e['id'] as String);
        }
      }
      for (final e in (arguments['update'] as List?) ?? []) {
        if (e is Map && e['id'] is String) {
          updateIds.add(e['id'] as String);
        }
      }
      for (final e in (arguments['delete'] as List?) ?? []) {
        if (e is Map && e['id'] is String) {
          deleteIds.add(e['id'] as String);
        }
      }
    ...
    // Throttle handling.
    if (onAssetsChangedLock != null) {
      return onAssetsChangedLock!.future;
    }
        ...
        return Consumer<DefaultAssetPickerProvider>(
          builder: (_, DefaultAssetPickerProvider p, __) {
            ...
            final labels = <String>[
              ...
              if (asset.title != null && asset.title!.isNotEmpty) asset.title!,
            ];
            return Semantics(
      ...
      builder: (context, asset) {
        ...
        return Stack(
          ...
          children: <Widget>[
            ...
            //         snapshot.data == ImageFileType.gif) {
